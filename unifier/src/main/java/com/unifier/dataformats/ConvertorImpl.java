...
public class ConvertorImpl implements Convertor {
    ...
    /**
     * Performs convertion of data from nexus provider to MapperUserModCommand structure
     * @param value input string
     * @return MapperUserModCommand object
    ...
    /**
     * Performs convertion of data from facebook provider to MapperUserModCommand structure
     * @param value input string
     * @return MapperUserModCommand object
     * @throws InvalidArgumentException
     */
