...
public class MapperUserModCommandTestCase {
    ...
    public void testUMCComparingNotEqualTimestamp() {
        MapperUserModCommand umc11 = new MapperUserModCommand("2011-12-03T10:15:30+01:00", "11", OperationHandler.ADD_OPERATION,
                testHelper.toArrayList(Arrays.asList("iphone","macbook", "magic mouse")));

        MapperUserModCommand umc22 = new MapperUserModCommand("2016-02-03T18:18:21+07:00", "11", OperationHandler.ADD_OPERATION,
                testHelper.toArrayList(Arrays.asList("iphone","macbook", "magic mouse")));
    ...
    public void testUMCComparingNotEqualUserId() {
        MapperUserModCommand umc11 = new MapperUserModCommand(Instant.EPOCH.toString(), "11", OperationHandler.ADD_OPERATION,
                testHelper.toArrayList(Arrays.asList("iphone","macbook", "magic mouse")));

        MapperUserModCommand umc22 = new MapperUserModCommand(Instant.EPOCH.toString(), "22", OperationHandler.ADD_OPERATION,
                testHelper.toArrayList(Arrays.asList("iphone","macbook", "magic mouse")));
    ...
    public void testUMCComparingNotEqualOperation() {
        ...
        MapperUserModCommand umc22 = new MapperUserModCommand(Instant.EPOCH.toString(), "11", OperationHandler.DELETE_OPERATION,
                testHelper.toArrayList(Arrays.asList("iphone","macbook", "magic mouse")));
    ...
    public void testUMCComparingNotEqualSegmentsList() {
        ...
        MapperUserModCommand umc22 = new MapperUserModCommand(Instant.EPOCH.toString(), "11", OperationHandler.ADD_OPERATION,
